...
%------------- BEGIN CODE --------------
    ...
    methods
        %% class constructor
        function obj = phtayELM(structure,phy_lay,weights,bias,activFcn)
            obj.phy_lay=phy_lay;
        ...
        % 
        output=phtayELMpredict(ELM,Input)
        
        % ELM predict

        ELM=trainphtayELM(obj,Input,Output)
% ELM predict
...
%         outputIntvl_array = outputSetNARMA(varargin)
    ...
    methods(Static)
phtayELM=GeneratephtayELM(structure,phy_lay,weights,bias,activFcn)
